let
  ...
  in
  {
    ...
    # System services.
    services = {
      # Stop annoying SSH attempts. This is pretty much essential for GCE, as
      # otherwise your machines will spend lots of precious CPU time and
      # network traffic responding to SSH attempts from scanners.
